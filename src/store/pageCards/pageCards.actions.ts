...
import { PageCardDtoWithIndex } from "./pageCards.store";
...
const initializePageCards = async () => {
  initializationStoreActions.setPartInitialized("pagecards");
};
...
export const pageCardsStoreActions = {
  addPageCards,
  initializePageCards,
  resetPageCards,
};
